                        ...
                        props.vacancies.map((vacancy) => (
                            <NavLink className="" to={"/vacancy/" + vacancy.id}>
                                <li className={styles.vac__item}>
                                    <div className="vac__list-info-wrapper">
                                        <div className="vac__list-info flex">
                                            <div className="vac__list-info-img ml-6">
                                                <img src={vacancy.pictures[0]} className={styles.vac__img} width="" height="" alt="" />
                                            </div>
                                            <div className="vac__list-info-desc flex-col ml-12">
                                                ...
                                                <div className="vac__list-location flex pt-4">
                                                    ...
                                                    <p className="location px-2 text-slate-400 max-md:text-sm">{vacancy.location.lat} : {vacancy.location.long}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="vac__list-ab max-lg:flex">
                                        <div className="vac__list-rt-fv flex">
                                        ...
                                        <p className="mt-6 mr-4 text-slate-400 max-lg:mt-10 max-md:text-sm max-md:pr-20 max-md:mt-2"> Posted at {vacancy.createdAt}</p>
                                    </div>
                                </li>
                            </NavLink>
                        ))
